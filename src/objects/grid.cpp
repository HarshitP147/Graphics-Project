...
public:
    Grid() : gridVAO(0), gridVBO(0), shaderProgram(0), mvpLocation(-1) {}
    ...
    void initialize() {
        ...
        shaderProgram = LoadShadersFromFile("../src/objects/grid.vert", "../src/objects/grid.frag");
        mvpLocation = glGetUniformLocation(shaderProgram, "MVP");

        // Grid data
        const int grid_size = 10;
        const float grid_spacing = 500.0f;
